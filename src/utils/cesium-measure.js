            ...
            */
            ...
            drawLineMeasureGraphics: function (options = {}) {
                if (this._viewer && options) {
                    var positions = []; var _lineEntity = new Cesium.Entity(); var $this = this; var lineObj
                    ...
                    function _addInfoPoint (position) {
                        console.info('11111111111111111111111111111111111111111')
            ...
            drawAreaMeasureGraphics: function (options = {}) {
                if (this._viewer && options) {
                    var positions = []; var polygon = new Cesium.PolygonHierarchy(); var _polygonEntity = new Cesium.Entity(); var $this = this; var polyObj = null; var _label = ''
            ...
            drawTrianglesMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    var _trianglesEntity = new Cesium.Entity(); var _tempLineEntity = new Cesium.Entity(); var _tempLineEntity2 = new Cesium.Entity()
                        var _positions = []; var _tempPoints = []; var _tempPoints2 = []; var $this = this
                        var _handler = new Cesium.ScreenSpaceEventHandler(this._viewer.scene.canvas)
                    // 高度
