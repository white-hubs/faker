...
<div class="usermodel">
    <div class="console_box">
      ...
      <div class="tablist">
        <div class="tablist-top">
          <p>摄像头列表</p>
          <el-button @click="cameraAdd">新增摄像头</el-button>
        </div>
        <el-table
          :data="tableData"
          stripe
          ...
          <el-table-column prop="cameraCode" label="设备编号" width="" ></el-table-column>
          ...
          <el-table-column prop="installTime" label="安装时间" width='210'></el-table-column>
    ...
    <div class="cameraForm" v-if="cameraSee" >
      <cameraSee  :editdata='edittableData'></cameraSee>
    </div>
...
<script>
  import cameraAdd from '../Addcomponents/cameraAdd'
  import cameraSee from '../Addcomponents/cameraSee'
  import { postQueryCameraList, postFindCameraList, postDeleteCameraList, postSwitchCameraList } from '../../../api/camera'
  ...
  export default {
    ...
    data () {
      return {
        ...
        cameraForm: false,
        cameraSee: false,
        queryRequest: postQueryCameraList,
        editRequest: postFindCameraList,
        deleteRequest: postDeleteCameraList,
        switchRequest: postSwitchCameraList,
        Editid: {},
        Seeid: {},
        tableData: [],
        edittableData: [],
    ...
    methods: {
      ...
      async getEditTableData () {
        try {
          ...
          console.log('jjkhjhj', this.edittableData)
        } catch (err) {
          if (err === 20003) {
            this.$message.error('登录过期')
            window.sessionStorage.token = ''
